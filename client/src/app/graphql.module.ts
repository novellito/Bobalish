...
export function createApollo(httpLink: HttpLink) {
  ...
  const auth = setContext((op, ctx) => ({
    headers: ctx.headers.append(
      ...
      // -- global jwt 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjp7InNlcnZpY2UiOiJkZWZhdWx0QGRlZmF1bHQiLCJyb2xlcyI6WyJhZG1pbiJdfSwiaWF0IjoxNTQxMzAxMDA3LCJleHAiOjE1NDE5MDU4MDd9.aFvPbYZuK-NTMIxqsi8PfaHbxjSU1FJkX4EUWdF0arc'
    )
  }));
  return {
